...
const sub = (f1: Fraction, f2:Fraction) => {
    const newNum = (f1.numerator * f2.denominator) - (f2.numerator * f1.denominator)
    const newDen = f1.denominator * f2.denominator
...
const multi = (f1: Fraction, f2:Fraction) => {
...
const div = (f1: Fraction, f2:Fraction) => {
...
const createFractionWithFunctions = (numerador:number, denominador:number) => {
