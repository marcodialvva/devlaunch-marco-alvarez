...
is the type of the ith sandwich in the stack (i = 0 is the top of the stack) and students [j]
...
students. length == sandwiches.length sandwiches [i] is 0 or 1. students [i] is 0 or 1.
*/

let students = [1,1,1,0,0,1]
let sandwiches = [1,0,0,0,1,1]

const pickASandwich = (students: number [], sandwiches: number []) => {
...
console.log (pickASandwich(students,sandwiches))
