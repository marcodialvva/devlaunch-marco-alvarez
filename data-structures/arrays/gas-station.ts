...
Given two integer arrays gas and cost, return the starting gas station's index if you can travel around the circuit the clockwise direction, 
...
const circularRoad = (gas: number[], cost: number[]): number => {
...
console.log(circularRoad(gas, cost)) 